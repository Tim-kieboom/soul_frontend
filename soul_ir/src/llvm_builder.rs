use inkwell::{
    ...
    context::Context,
    types::{BasicType, FloatMathType, IntMathType, PointerMathType},
    values::{
        BasicMetadataValueEnum, BasicValue, BasicValueEnum, CallSiteValue, FloatMathValue,
        FunctionValue, InstructionValue, IntMathValue, IntValue, PointerMathValue, PointerValue,
    },
};
use soul_utils::{
...
impl<'ctx> IrBuilder<'ctx> {
    ...
    pub fn inkwell(&self) -> &Builder<'ctx> {
        &self.inkwell
    }
    ...
    {
        self.inkwell
            .build_int_add(left, right, "add_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_add(left, right, "add_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_sub(left, right, "sub_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_sub(left, right, "sub_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_mul(left, right, "mul_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_mul(left, right, "mul_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_signed_div(left, right, "div_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_unsigned_div(left, right, "div_uint")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_div(left, right, "div_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_signed_rem(left, right, "rem_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_unsigned_rem(left, right, "rem_uint")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_xor(left, right, "xor_int")
            .map_err(build_error)
    }

    pub fn build_int_compare<T>(
        &self,
        op: IntPredicate,
        left: T,
        right: T,
    ) -> SoulResult<<T::BaseType as IntMathType<'ctx>>::ValueType>
    where
        T: IntMathValue<'ctx>,
    {
        self.inkwell
            .build_int_compare(op, left, right, "cmp_int")
            .map_err(build_error)
    }

    pub fn build_float_compare<T>(
        &self,
        op: FloatPredicate,
        left: T,
        right: T,
    ...
    {
        self.inkwell
            .build_float_compare(op, left, right, "cmp_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_neg(left, "neg_float")
            .map_err(build_error)
    }
    ...
    where
        T: IntMathValue<'ctx>,
    {
        self.inkwell.build_not(left, "not_int").map_err(build_error)
    }

    pub fn build_int_to_ptr<T>(
        &self,
        int: T,
    ...
    {
        self.inkwell
            .build_int_to_ptr(int, ptr_type, "cast_int_to_ptr")
            .map_err(build_error)
    }

    pub fn build_ptr_to_int<T>(
        &self,
        ptr: T,
    ...
    {
        self.inkwell
            .build_ptr_to_int(ptr, int_type, "cast_ptr_to_int")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_s_extend(int_value, int_type, "cast_int_ext")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_z_extend(int_value, int_type, "cast_uint_ext")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_int_truncate(int_value, int_type, "cast_uint_turnc")
            .map_err(build_error)
    }

    pub fn build_float_to_signed_int<T>(
        &self,
        float: T,
    ...
    {
        self.inkwell
            .build_float_to_signed_int(float, int_type, "cast_float_to_int")
            .map_err(build_error)
    }

    pub fn build_float_to_unsigned_int<T>(
        &self,
        float: T,
        int_type: <T::BaseType as FloatMathType<'ctx>>::MathConvType,
    ) -> SoulResult<
    ...
    {
        self.inkwell
            .build_float_to_unsigned_int(float, int_type, "cast_float_to_uint")
            .map_err(build_error)
    }

    pub fn build_signed_int_to_float<T>(
        &self,
        int: T,
    ...
    {
        self.inkwell
            .build_signed_int_to_float(int, float_type, "cast_int_to_float")
            .map_err(build_error)
    }

    pub fn build_unsigned_int_to_float<T>(
        &self,
        int: T,
        float_type: <T::BaseType as IntMathType<'ctx>>::MathConvType,
    ) -> SoulResult<
    ...
    {
        self.inkwell
            .build_unsigned_int_to_float(int, float_type, "cast_uint_to_float")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_bit_cast(val, ty, "bit_cast")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_ext(float, float_type, "cast_float_ext")
            .map_err(build_error)
    }
    ...
    {
        self.inkwell
            .build_float_trunc(float, float_type, "cast_float_trunc")
            .map_err(build_error)
    }

    pub fn get_field_ptr<T>(
        &self,
        base_type: T,
        ...
        V: BasicValue<'ctx>,
    {
        let geb = self
            .inkwell
            .build_struct_gep(struct_ir, ptr, field_index as u32, "gep_x")
            .map_err(build_error)?;
