use crate::{steps::{parse::{parse_statement::{CURLY_OPEN, ROUND_OPEN, SQUARE_OPEN, SQUARE_CLOSE, STAMENT_END_TOKENS}, parser::Parser}, tokenize::token_stream::{Number, TokenKind}}, utils::try_result::TryError};
use models::{abstract_syntax_tree::{expression::{Expression, ExpressionKind, Index, ReturnKind, ReturnLike}, expression_groups::ExpressionGroup, literal::Literal, operator::{Binary, BinaryOperator, Unary, UnaryOperator, UnaryOperatorKind}}, error::{SoulError, SoulErrorKind, SoulResult, Span}, soul_names::{self, AccessType, KeyWord, Operator, TypeModifier}, symbool_kind::SymboolKind};
