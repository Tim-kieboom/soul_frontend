use ast::ArrayKind;
use hir::{
    CustomTypeId, DisplayType, HirType, HirTypeKind, InferTypesMap, LazyTypeId, TypeId, TypesMap,
};
use soul_utils::{
...
impl UnifyPrimitiveCastLazy for HirTypeKind {
    fn unify_primitive_cast(
        ...
        Ok(match (self, should_be) {
            ...
            (_, HirTypeKind::Pointer(_)) | (_, HirTypeKind::Primitive(PrimitiveTypes::CStr)) => {
                return Ok(());
            }
